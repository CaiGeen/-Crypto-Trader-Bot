...
# ⚠️ F1/F2/F4b（2026-08-21，事件3修复四件套）再偏移：F4b __init__(+1)+helper(+3) 插在 1318 前 → 前 4 处 +4；
#      F1 _order_matches_intent 重写(+78) 插在 2273~3670 之间 → 其余 +82。重新实测 2026-08-21：
#      实测 create 调用点 = [1322, 1473, 1687, 2273, 3752, 3826, 4323, 4480, 4610, 4913, 5060, 5212, 5481, 5664]
A_LINES = {1322, 1473, 1687, 3752, 3826, 4323, 4480, 4610, 4913, 5060, 5212}  # 11 处保护单
B_LINES = {2273}                                                              # 1 处开仓条件单
C_LINES = {5481, 5664}                                                        # 2 处平仓单
