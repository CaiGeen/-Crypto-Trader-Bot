...
之前失败原因：任何"收盘价破KAMA"太频繁（2107次）

新定义：跌破KAMA = 价格在KAMA之上运行至少20根K后，收盘跌破KAMA
这代表"趋势结束"，而不是日常波动
"""
import os, sys
...
# 新定义：跌破KAMA = 价格在KAMA之上运行至少ABOVE_K根K后，收盘跌破KAMA
pause_start = []
above_count = 0
...
print(f"新定义：在KAMA之上运行>= {ABOVE_K}根K后跌破KAMA")
...
print("\n" + "=" * 100)
print(f"跌破KAMA后暂停{PAUSE_K}根K线测试（新定义）")
print("=" * 100)
...
stats(results_pause, f"2.跌破KAMA暂停{PAUSE_K}K")
