...
full.to_csv("results/全波段明细_订单状态机_E6自武装起算.csv", index=False, encoding="utf-8-sig")
trade_df.to_csv("results/成交明细_订单状态机_E6自武装起算.csv", index=False, encoding="utf-8-sig")
