...
# 按涨跌幅降序排列
swings_df = swings_df.sort_values('涨跌幅%', ascending=False).reset_index(drop=True)
...
# 保存CSV
output_path = os.path.join(HERE, "results", "KAMA同向20K大波段数据.csv")
